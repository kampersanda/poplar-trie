...
template <typename Value, uint64_t Lambda = 16>
using map_pp_ex = map<plain_bonsai_trie<>, plain_label_store_ex<Value>, Lambda>;
...
template <typename Value, uint64_t ChunkSize = 16, uint64_t Lambda = 16>
using map_pc_ex = map<plain_bonsai_trie<>, compact_label_store_ex<Value, ChunkSize>, Lambda>;

template <typename Value, uint64_t Lambda = 16>
using map_cp = map<compact_hash_trie<>, plain_label_store<Value>, Lambda>;

template <typename Value, uint64_t Lambda = 16>
using map_cp_ex = map<compact_bonsai_trie<>, plain_label_store_ex<Value>, Lambda>;

template <typename Value, uint64_t ChunkSize = 16, uint64_t Lambda = 16>
using map_cc = map<compact_hash_trie<>, compact_label_store<Value, ChunkSize>, Lambda>;

template <typename Value, uint64_t ChunkSize = 16, uint64_t Lambda = 16>
using map_cc_ex = map<compact_bonsai_trie<>, compact_label_store_ex<Value, ChunkSize>, Lambda>;
