...
class plain_label_store {
 ...
 public:
  ...
  explicit plain_label_store(uint32_t capa_bits) {
  ...
  plain_label_store(const plain_label_store&) = delete;
  plain_label_store& operator=(const plain_label_store&) = delete;

  plain_label_store(plain_label_store&&) noexcept = default;
  plain_label_store& operator=(plain_label_store&&) noexcept = default;
